...
* **Parameters:**
  ...
  * **schema** (*Optional* **[*dict* **[*str* *,* *type* *]* *]* *,* *default=None*) – 
    ...
    Supported types: `int`, `float`, `str`, [`otp.string[N]`](https://docs.pip.distribution.sol.onetick.com/api/types/string.html.md#onetick.py.string),
    `otp.varstring[N]`,
    ``otp.nsectime``,
    ``otp.msectime``,
    ``otp.decimal``, `bytes`.
...
``onetick.py.Source.ob_snapshot_flat()``

``onetick.py.agg.ob_snapshot_flat()``
