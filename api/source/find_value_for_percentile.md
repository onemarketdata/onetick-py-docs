...
#### ``Source.find_value_for_percentile(percentile, show_percentile_as, running=False, bucket_interval=0, bucket_units=None, bucket_time='end', bucket_end_condition=None, boundary_tick_bucket='new', group_by=None, groups_to_display='all', end_condition_per_group=False)``
...
* **Parameters:**
  * **percentile** (*int*) – Specifies the percentile number in 0-100% range
