...
### ``corp_actions(source, adjustment_date=None, adjustment_date_tz=default, fields=None, adjust_rule='PRICE', apply_split=True, apply_spinoff=False, apply_rights=None, apply_cash_dividend=False, apply_stock_dividend=False, apply_security_splice=False, apply_others='', apply_all=False)``
