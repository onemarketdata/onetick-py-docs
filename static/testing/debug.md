...
In code your set or [`otp.config['show_stack_info']`](../../api/config.md#onetick.py.configuration.Config) or the `OTP_SHOW_STACK_INFO` env variable to enable this option (more about it is `here`)
